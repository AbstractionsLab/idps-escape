...
- ?c5-defect-0: In the Anomaly Detection menu, the created detector is visible. The expected configurations are found in [`config.yaml`](/soar-radar/config.yaml) under the `log_volume` key.

...
level: 2.18
links:
- TST-058: KOlB_yZm2OzR0sSaC4Elc8zFKzJaIlq6sBKPrnJF9ck=
normative: true
not-executed-steps: '0'
passed-steps: '11'
ref: ''
release-version: '0.7'
reviewed: wbtmhtPEHdAbFTaLHqSaZokTdjat93zz9kd34llvl1k=
test-date: 2026-02-03
tester: AAT
verification-method: T
---

# TCER: RADAR build non-whitelist GeoIP detection with case creation
...
- ?c5-defect-0: The active response directory `/var/ossec/active-response/bin/` has files `ar.yaml` and `pyflowintel`.

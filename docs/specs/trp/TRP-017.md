...
ref: ''
release-version: '0.1'
reviewed: xiB-Pbg_-Eg8YomoEcWNiKOtESWx_8CTucqgRjXeo9Q=
test-date: '2024-07-26'
tester: AGI
verification-method: T
---

# TCER: ADBox use case 2 without a Wazuh connection
...
**Test case step 1**: Run `adbox` with use case scenario 2 (no Wazuh connection) — ?c5-defect-0

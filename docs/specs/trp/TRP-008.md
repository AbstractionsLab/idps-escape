...
ref: ''
release-version: '0.1'
reviewed: hu1hYN-W7ZiCh-OSxUqfAtsydxTBL1wbeL3HsGC-owE=
test-date: '2024-07-25'
tester: AGI
verification-method: T
---

# TCER: ADBox use case 1 with a Wazuh connection
...
**Test case step 1**: Run `adbox` with use case scenario 1 — ?c5-defect-0

...
**Implementation**: [sonar/features.py](sonar/features.py)
...
- Feature configuration: [docs/manual/sonar_docs/scenario-guide.md](docs/manual/sonar_docs/scenario-guide.md)
- Architecture: [docs/manual/sonar_docs/architecture.md](docs/manual/sonar_docs/architecture.md#feature-engineering)
- Implementation: [sonar/features.py](sonar/features.py)
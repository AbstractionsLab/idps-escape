...
package "Configuration Files" {
  ...
  component "inventory.yaml" as Inventory {
    [wazuh_manager_local]
    [wazuh_manager_ssh]
...
Inventory --> Ansible : host groups
Volumes --> Ansible : path resolution

BuildScript --> ConfigYAML : validates scenario
BuildScript --> Inventory : limits execution
...
**Full example**: See [radar/inventory.yaml](radar/inventory.yaml)

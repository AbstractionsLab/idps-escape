...
ref: ''
release: Alpha
reviewed: j7wdbLKaD_dxOcZvmET4Qbu9dFXns_poKjaFa7qjl2A=
version: '0.4'
---

# RADAR integration with Opensearch modules

The diagram below depicts how RADAR integrates with Wazuh Opensearch modules.

![RADAR integration](assets/RADAR-integration.png "RADAR integration"){: width="90%"}
...
ref: ''
release: alpha
reviewed: Fh9VIaXNh_deqWc9XNGSNqg1o5Hygmf2MDcrXrH89Tc=
test_data: see referenced files
verification_method: T
version: 0.8
---

# Build log volume abnormal growth
...
3. To clean up the test environment **only after** a _successful_ test execution **AND** a successful execution of [TST-048](./TST.html#TST-048):

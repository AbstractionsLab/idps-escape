...
ref: ''
release: alpha
reviewed: P5Q3Lk8Fp2vxdVrCs-WZCcbgBPoZyRiKxvG5x3Y9TBA=
...
3. To clean up the test environment **only after** a _successful_ test execution **AND** a successful execution of [TST-055](./TST.html#TST-055):
...
- **2.8** RADAR helper directory and script are installed on the SSH agent host.
```
ls -ld /opt/radar
...
- **2.9** `radar-helper.service` systemd unit is installed, enabled, and running.
```

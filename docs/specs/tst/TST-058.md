...
ref: ''
release: alpha
reviewed: hamEVsgWTLimknqfu15caNunKV0Yi20vyi7HrVXQtkQ=
test_data: see referenced files
verification_method: T
version: 0.7
---

# RADAR: build non-whitelist GeoIP detection with case creation

## Preconditions and setup actions
- RADAR is setup according to [TST-057](./TST.html#TST-057)
...
3. To clean up the test environment **only after** a _successful_ test execution **AND** a successful execution of [TST-059](./TST.html#TST-059):

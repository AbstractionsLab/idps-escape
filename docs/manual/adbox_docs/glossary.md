...
| Time-series        | See [Time-series](./time_series.md)           |
...
| Unit timestamp     | Initial timestamp of a granularity interval. See [Aggregation and Granularity](./runmodes.md#aggregation-and-granularity). |

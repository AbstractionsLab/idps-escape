...
Once a detector is created, numerous files are created as explained [here](./detector_data_structure.md), more so if the data shipping is enabled [detector data streams](./detector_data_stream.md) and templates are created too.

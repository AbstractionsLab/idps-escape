...
The DataAggregator extracts and aggregates features from time-series data based on granularity and aggregation methods specified in the currently selected [use case](./use_case.md). Its methods may be called as part of the preprocessing.

### Data preprocessor

The DataPreprocessor runs all the transformations that are strictly part of the ML preprocessing, including feature extraction and possibly aggregation, as specified in the currently selected [use case](./use_case.md).

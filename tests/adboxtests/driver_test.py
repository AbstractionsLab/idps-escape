...
from adbox.ad_driver.driver import main
...
class TestDriver(unittest.TestCase):
    ...
    def test_s(self):
        with patch('adbox.ad_driver.driver.WazuhDataShipper') as MockWDS:
    ...
    def test_u(self):
        with patch('adbox.ad_driver.driver.ADEngine', spec=True) as MockEngine:
    ...
    def test_i(self):
        with patch('adbox.ad_driver.driver.Console') as mock_console:
            main()
    ...
    def test_c(self):
        with patch('adbox.ad_driver.driver.WazuhDataIngestor') as MockWDI:
            with self.assertRaises(SystemExit): 
                main()

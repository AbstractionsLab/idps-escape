...
from adbox.shipper.wazuh_data_shipper import CREATE, DELETE, TemplateHandler, WazuhDataShipper
from adbox.shipper.wazuh_base_template import AD_BASE_TEMPLATE, AD_BASE_TEMPLATE_NAME, AD_DETECTOR_PATTERN, MAPPINGS, PROPERTIES, TEMPLATE, TYPE
...
class TestShipperOnline(unittest.TestCase):
    ...
    @patch('adbox.shipper.wazuh_data_shipper.MAP_ALG_COMPONENT',TEST_MAP_ALG_COMPONENT)

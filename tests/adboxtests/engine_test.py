...
class TestEngineTraining(unittest.TestCase):
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.train')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.transform')
...
class TestEngineHistorical(unittest.TestCase):
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.ingest_prediction')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.transform')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.predict')
...
class TestEngineTrainHistorical(unittest.TestCase):
    @patch('adbox.data_manager.spot_manager.SPOTManager._load_all')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.ingest_prediction')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.ingest_training')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.transform')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.predict')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.train')
...
class TestEngineBatch(unittest.TestCase):
    ...
    @patch('adbox.time_manager.TimeManager.now_str')
    @patch('adbox.data_manager.spot_manager.SPOTManager._load_all')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.ingest_prediction')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.transform')
    @patch('adbox.ad_engine.mtad_gat.ad_engine.ADEngine.predict')

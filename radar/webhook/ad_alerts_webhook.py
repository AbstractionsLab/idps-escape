...
def receive_alert():
    ...
    anomaly_grade   = data.get("anomaly_grade", "")
    anomaly_confidence   = data.get("anomaly_confidence", "")
    ...
    body = f'OpenSearchAD {trg}: entity="{ent}", start="{start}", end="{end}", anomaly_grade="{anomaly_grade}", anomaly_confidence="{anomaly_confidence}" '

...
if __name__ == "__main__":
    conf_manager=TrainConfigManager('/home/alab/siem-mtad-gat/adbox/mtad_gat_pytorch/train_config_example_input.json')
    my_config=conf_manager.load_config()
    conf_manager.save_config_file("/home/alab/siem-mtad-gat/adbox/mtad_gat_pytorch/train_config.json")

...
class Plotter:
    ...
    def __init__(self, result_path, model_id='-1'):
        ...
        config_path = f"{self.result_path}/training_config.json"
        with open(config_path) as f:
            self.lookback = json.load(f)["window_size"] # json.load(f)["lookback"]
    ...
    def _load_results(self):
        ...
        train_output = pd.read_pickle(f"{self.result_path}/output/train_output.pkl")
        train_output.to_pickle(f"{self.result_path}/output/train_output.pkl")
        train_output["A_True_Global"] = 0
        test_output = pd.read_pickle(f"{self.result_path}/output/test_output.pkl")
